...
In later posts, we'll want to predict a given feature which we refer to as our target. The remaining features will act as our input data to predict the target. Thus it can be usefull to split our input features and target into two different variables.
```{r}
...
In the following app, we'll practice using sliders and selection tools to filter data for description and visualization. The code is below with a few comments to serve as guidance, the result follow!
